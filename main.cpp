...
bool operator==(VkExtensionProperties val1, std::string str) {
  return !str.compare(val1.extensionName);
}
...
private:
  ...
  void createSwapChain() {
    ...
    // https://disq.us/url?url=https%3A%2F%2Fgithub.com%2FKhronosGroup%2FVulkan-Docs%2Fissues%2F909%3AK0FuaVsz6-PcNc-2Wux2XHvprzI&cuid=4237875
  ...
  void updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.model = glm::rotate(glm::mat4(1.0f), time * glm::radians(90.0f) / 2,
  ...
  std::vector<const char *> getRequiredExtensions() {
    ...
    std::vector<const char *> requiredExtensions(
        extensionString, extensionString + requiredExtensionCount);
  ...
  static void framebufferReizeCallback(GLFWwindow *window, int width,
                                       int height) {
