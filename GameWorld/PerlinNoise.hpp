#ifndef VCraft_perlin_impl
#define VCraft_perlin_impl

class PerlinNoise {
public:
  PerlinNoise() = delete;

  PerlinNoise(int seed, int i, int j, int k) {
    perm = {151, 160, 137, 91,  90,  15,  131, 13,  201, 95,  96,  53,  194,
...
private:
  std::vector<int> perm;
  int generationFn(int seed, int i, int j, int k){return (seed * i * i)%100 + (j * j * j)%40 - k;}
